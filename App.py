...
Homepage_Links = [{"Identifier": "IMDB Top 100 by rating", "Know More":"Nah! that's just a Hoax!", "Still wanna know more": "what part of Hoax do you not understand"},
{"Identifier": "IMDB Extreme Graphic content", "Know More":"so you're into Kinky, Ehh laddie?", "Still wanna know more": "Good taste, Chap!"},
{"Identifier": "IMDB Classics", "Know More":"so you're a Pulp Fiction Guy!", "Still wanna know more": "Heavenly intervention"},
{"Identifier": "Booring", "Know More":"Booring list", "Still wanna know more": "Remaining list starting top 100 first, Phew", "routeData":"Booring" }]
...
def start_Page():
    ...
    return render_template("Start_Animation.html", content=Homepage_Links, pageheader="That's Just Bollocks, mate, Honestly, IDK what shit's about to be rolled")

@app.route('/Booring', methods = ['GET', 'POST'])
def Booring():
    return render_template("Start_Animation.html", content=contentTobeSent, pageheader="IMDb's Top 100 for 2021 movies")
